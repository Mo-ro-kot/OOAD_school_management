...
export default function AssignmentResponses() {
  ...
  // Mock student responses - in real app, fetch from backend
  const [responses, setResponses] = useState([
    {
      id: 1,
      studentName: "Pory Morokot",
      studentEmail: "pory.m@school.edu",
      submittedAt: "14 Nov 2025 10:30 AM",
      status: "Submitted",
      score: 85,
      feedback: "Great work! Well organized and clear.",
      submissionFile: "assignment_pory.pdf",
    },
    {
      id: 2,
      studentName: "Sokha Mean",
      studentEmail: "sokha.m@school.edu",
      submittedAt: "15 Nov 2025 2:15 PM",
      status: "Submitted",
      score: null,
      feedback: "",
      submissionFile: "assignment_sokha.pdf",
    },
    {
      id: 3,
      studentName: "Dara Sovann",
      studentEmail: "dara.s@school.edu",
      submittedAt: "16 Nov 2025 9:00 AM",
      status: "Submitted",
      score: null,
      feedback: "",
      submissionFile: "assignment_dara.pdf",
    },
    {
      id: 4,
      studentName: "Chan Piseth",
      studentEmail: "chan.p@school.edu",
      submittedAt: null,
